...
| `/updatefirstmate` | Guardedly update firstmate and its secondmates, then evaluate safe restarts; busy or unprovable mates remain running (see the [update procedure](.agents/skills/updatefirstmate/SKILL.md) for current deferral limits) |
