...
Closing this gap also owes rovo's typed-plane mid-turn refusal row; `.agents/skills/harness-adapters/references/harness/rovo.md` "Skill-loading interop gap" owns that requirement.
