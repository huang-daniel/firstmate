...
The primary admits every pipeline start on a project with a validation ceiling through `bin/fm-validation-slot.sh` before the worker is triggered, whichever home owns the crew.
