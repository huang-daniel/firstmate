...
# fm_closeout_block owns the three closeout fields every ship worker fills at its
# done report. It is emitted only through fm_dod_block, so an ordinary ship brief
